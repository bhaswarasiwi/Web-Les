...
<body>
  ...
  <nav class="navbar navbar-light bg-light static-top">
    <div class="container">
      <a class="navbar-brand" href="#">Les Privat Baitul Jannah</a>
      <a class="btn btn-primary" href="<?php echo base_url('index.php/login'); ?>">Masuk</a>
    </div>
  </nav>
    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          <h1 class="mb-5">Pendidikan akal tanpa pendidikan hati, sama saja bukan pendidikan yang sesungguhnya</h1>
        </div>
        <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
          <form>
            <div class="form-row">
              <div class="col-12 col-md-12">
                <h2 class="mb-5">Mari bergabung bersama kami</h2>
                
              </div>
              <div class="col-12 col-md-12">
                <a class="btn btn-block btn-lg btn-primary" href="<?php echo base_url('index.php/daftar'); ?>">Daftar Sekarang</a>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
            ...
            <h3>Materi</h3>
            <p class="lead mb-0">Kualitas Materi terjamin</p>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="features-icons-item mx-auto mb-0 mb-lg-3">
            ...
            <h3>Waktu</h3>
            <p class="lead mb-0">Waktu Les yang fleksibel</p>
          </div>
        </div>
      </div>
    </div>
